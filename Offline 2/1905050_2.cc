...
main(int argc, char* argv[])
{
    ...
    // Create wifi channel
    YansWifiChannelHelper wifiChannelSender = YansWifiChannelHelper::Default();
    YansWifiChannelHelper wifiChannelReceiver = YansWifiChannelHelper::Default();
    YansWifiPhyHelper phySender, phyReceiver;
    phySender.SetChannel(wifiChannelSender.Create());
    phyReceiver.SetChannel(wifiChannelReceiver.Create());
    ...
    mobility.SetPositionAllocator(
        ...
        DoubleValue(0.0),
        "Rho",
        StringValue("ns3::UniformRandomVariable[Min=0|Max=" + std::to_string(circleRadius) + "]"),
        "Theta",
    ...
    mobility.SetMobilityModel(
        ...
        "Bounds",
        RectangleValue(Rectangle(-circleRadius, circleRadius, -circleRadius, circleRadius)),
        "Speed",
        StringValue("ns3::ConstantRandomVariable[Constant=" + std::to_string(NUM_SPEED) + "]"));
    ...
    // std::cout << "Number size of senderApps: " << senderApps.GetN() << std::endl;
    ...
    outputStream << avgThroughput << " " << packetDeliveryRatio << " " << NUM_WIFI << " " << NUM_FLOW << " " << NUM_PACKET << " " << NUM_SPEED << std::endl;
